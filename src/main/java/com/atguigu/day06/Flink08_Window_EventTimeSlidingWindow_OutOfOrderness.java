...
public class Flink08_Window_EventTimeSlidingWindow_OutOfOrderness {
    public static void main(String[] args) throws Exception {
        ...
        //6.开窗                                                                          //事件时间
        WindowedStream<WaterSensor, String, TimeWindow> windowedStream = keyedStream.window(SlidingEventTimeWindows.of(Time.seconds(6),Time.seconds(2)));
