...
public class Flink11_Window_EventTimeTumblingWindow_SideOutPut {
    public static void main(String[] args) throws Exception {
        //TODO 测试滚动事件时间，乱序，允许迟到数据
        //1.获取执行环境
        ...
        WindowedStream<WaterSensor, String, TimeWindow> windowedStream = keyedStream
                ...
                .sideOutputLateData(new OutputTag<WaterSensor>("lateDate") {
                });;
        ...
        result.print(">>>>>>>>>>>");
        //获取侧输出流进行打印
        result.getSideOutput(new OutputTag<WaterSensor>("lateDate") {
        }).print("SideOut>>>>>>>>>>>>");
