...
public class Flink03_Window_ProcessTime_SessionWindow {
    public static void main(String[] args) throws Exception {
        ...
        //5.开窗，按照时间的滑动窗口
        WindowedStream<Tuple2<String, Long>, String, TimeWindow> windowedStream = keyedStream.window(ProcessingTimeSessionWindows.withGap(Time.seconds(3)));
